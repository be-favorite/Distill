...
# 본 포스트 영어 제목: Do time series analysis with tidyverse principle
# 본 포스트 한글 제목: tidyverse principle로 시계열 자료 분석하기
...
[![Photo by Agê Barros on Unsplash](preview.jpg){width="700"}](https://unsplash.com/photos/rBPOfVqROzY?utm_source=unsplash&utm_medium=referral&utm_content=creditShareLink)

<aside>

본 글은 [@tidyvert]을 기반으로 작성되었습니다.
